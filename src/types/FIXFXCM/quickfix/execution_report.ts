...
import { IExecutionReportNoUnderlyings } from './set/execution_report_no_underlyings'
...
import { IExecutionReportNoMiscFees } from './set/execution_report_no_misc_fees'
...
export interface IExecutionReport {
  ...
  NoUnderlyings?: IExecutionReportNoUnderlyings[]
  Side: string// 54
  ...
  NoMiscFees?: IExecutionReportNoMiscFees[]
  FXCMPosID?: string// 9041
  FXCMOrdStatus?: string// 9051
  FXCMOrdType?: string// 9050
