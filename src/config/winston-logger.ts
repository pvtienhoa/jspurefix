...
export class WinstonLogger {
  ...
  public plain(fileName: string, maxSize: number = 100 * 1024 * 1024, haveTimeStamp: boolean = false, isZipped: boolean = true, maxFile: string = '7d', dirName: string = '.'): IJsFixLogger {
