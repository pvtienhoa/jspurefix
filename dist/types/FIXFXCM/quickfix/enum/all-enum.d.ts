...
export declare enum MsgType {
    ...
    FxcmNewsRequest = "U50",
    FxcmNewsTopicRequest = "U51",
    FxcmRequestReject = "U52",
    FxcmNewsTopicResponse = "U53"
}
...
export declare enum UserRequestType {
    ...
    RequestListOfTradingSessions = 5
}
...
export declare enum FXCMTimingInterval {
    Spot = 0,
    Min1 = 1,
    Min5 = 2,
    Min15 = 3,
...
export declare enum FXCMContinuousFlag {
    Single = 0,
    PartOfPackage = 1,
    EndOfPackage = 2
}
export declare enum FXCMRequestRejectReason {
    Unknown = 0,
    Generic = 1,
    DataNotFound = 2,
    TradingSessionNotFound = 3,
    Other = 4
}
export declare enum FXCMOrdType {
    Open = "O",
    PhoneOpen = "OF",
    OpenMarket = "OM",
    OpenLimit = "OL",
    ...
    MarginCall = "M",
    EquityStopOrder = "Q",
    TrailingStopOrder = "ST",
    TrailingLimitOrder = "LT",
    LimitTrailingEntry = "LTE",
    StopTrailingEntry = "STE",
    Rfq = "R"
}
export declare enum FXCMOrdStatus {
    Waiting = "W",
    Inprocess = "P",
